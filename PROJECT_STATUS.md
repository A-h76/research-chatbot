...
**Phase 2.3 — Research Intelligence:** Sprint 0–5 **shipped** (Query → Retrieval → Ranking → Consensus → Conflict → Reasoning). Next: Sprint 6 Writing Intelligence (generation last).
