...
**Phase 2.3 — Research Intelligence:** Sprint 0–6 **complete** (Query → Retrieval → Ranking → Consensus → Conflict → Reasoning → Writing Intelligence `grounded_v0`). Next: Reviewer / Compare / Assistant surfaces (ADD-0005).
