...
PROVIDER_DEFS: list[dict[str, Any]] = [
    ...
    _provider(
        ...
        auth="none",
        brand_color="#1857B6",
        logo="brands/semanticscholar.png",
