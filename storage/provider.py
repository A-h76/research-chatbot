...
class StorageProvider(Protocol):
    ...
    def presigned_get_url(self, key: str, filename: str, mime: str, expires_in: int = 300) -> str: ...
    ...
    def presigned_part_url(self, key: str, upload_id: str, part_number: int, expires_in: int = 3600) -> str: ...
    def complete_multipart_upload(self, key: str, upload_id: str, parts: list[UploadPart]) -> None: ...
